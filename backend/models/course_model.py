...
class CourseResponse(BaseModel):
    ...
    total_std: int = 0  # ADDED: จำนวนนักศึกษาใน course
    total_assign: int = 0  # ADDED: จำนวน assignment ใน course
    total_submitted_student: int = 0  # ADDED: จำนวน submission รวมของทุก assignment ใน course
